...
# ogive length
Lo = np.sqrt( (rho * fairing_dia) - R**2)
...
geo.addPoint( x, y1, z, h * 0.01, 204 )
geo.addPoint( x, y2, z, h * 0.01, 205 )
x = Lo; y1 = R; y2 = -R
geo.addPoint( x, y1, z, h * 0.01, 11 )
geo.addPoint( x, y2, z, h * 0.01, 4 )
geo.addCircleArc( 3, 204, 4, 31 )
geo.addCircleArc( 11, 205, 2, 40 )
...
mesh.recombine()
mesh.generate(2)
gmsh.write('turb_gslv_cgrid.su2')
gmsh.fltk.run()
gmsh.finalize()
